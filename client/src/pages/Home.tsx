...
export const Home = () => {
  ...
  const createNewRoom = (e: React.MouseEvent<HTMLAnchorElement>) => {
    ...
    const id = uuid_v4()
    setRoomId(id)
    sessionStorage.setItem('rtce:roomId', id)
  ...
  const joinRoom = () => {
    ...
    sessionStorage.setItem('rtce:roomId', roomId)
    sessionStorage.setItem('rtce:userName', userName)
      ...
      <div className="form-wrapper">
        ...
        <div className="input_group">
          ...
          <span className="createInfo">
            If you have no invitation then create&nbsp;
